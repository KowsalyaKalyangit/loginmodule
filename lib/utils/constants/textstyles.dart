...
final forminputstyle = GoogleFonts.jost(
    textStyle: TextStyle(
        fontSize: 10.00.sp, color: Colors.black, fontWeight: FontWeight.w500));

final formhintstyle = GoogleFonts.jost(
    textStyle: TextStyle(
        fontSize: 9.00.sp, color: Colors.black, fontWeight: FontWeight.w500));
...
final viewmore = GoogleFonts.jost(
    textStyle: TextStyle(
        fontSize: 12.00.sp, color: Colors.blue, fontWeight: FontWeight.w700));
